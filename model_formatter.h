...
void dialog_000(void){
  d_n("Eres el famoso detective Renne",1);
    ...
    d("siete a<os, tras acabar tu",3);
}

void dialog_001(void){
  d_n("relaci$n m*s duradera. La fama",1);
...
void dialog_003(void){
  d_n("Hace unos d|as, recibiste una",1);
    d("carta de una vieja amiga y todo",2);
    d("cambi$.",3);
}

void dialog_004(void){
  d_n("`Cu*nto tiempo Renne! Te escribo",1);
...
void dialog_005(void){
  d_n("unos amigos. He hablado con la",1);
    d("polic|a, pero no han encontrado",2);
    d("pruebas con las que poder investigar.",3);
}

void dialog_006(void){
  d_n("Me gustar|a contratarte para este",1);
...
void dialog_023(void){
    ...
    d("mencionas en la carta, ;qui&nes",2);
    d("son?",3);
}
...
void dialog_024(void){
    ...
    d("Alice Zena. Hace unos tres a<os",2);
    d("que los conoc|.",3);
}
...
void dialog_025(void){
    ...
    d("sobre su relaci$n? ;Son amigos",2);
    d("o hay algo m*s?",3);
}
...
void dialog_029(void){
    ...
    d("portugu&s en mi colegio.",2);
    d("",3);
}

void dialog_030(void){
    h("[ Renne ]");
                d(";C$mo describir|as la",1);
    d("relaci$n de ambos?",2);
    d("",3);
}
...
void dialog_036(void){
    ...
    d("m*s unida a Alice que a Cristiano,",2);
    d(";me equivoco?",3);
}
...
void dialog_038(void){
    ...
    d("la vida de Cristiano, m*s all* de",2);
...
void dialog_039(void){
    ...
    d("sol|a beber en el bar que hab|a ",2);
    d("enfrente de su oficina.",3);
}

void dialog_040(void){
    h("[ Renne ]");
                d(";Conoc|as a Cristiano",1);
    d("antes de su relaci$n con Alice?",2);
    d("",3);
}
...
void dialog_042(void){
    h("[ Renne ]");
                d("Bien. ;C$mo te diste",1);
    d("cuenta de que los dos hab|an",2);
    d("desaparecido?",3);
}
...
void dialog_043(void){
    ...
    d("coche, as| que los ve|a todos los",2);
    d("d|as de camino al trabajo.",3);
}

void dialog_044(void){
    h("[ Julia ]");
                d("Hace justo una semana ",1);
    d("Alice me coment$ que quer|a ir",2);
    d("al faro.",3);
}
...
void dialog_048(void){
    h("[ Julia ]");
                d("Es el monumento m*s",1);
    d("importante de la ciudad, se construy$",2);
    d("como reclamo tur|stico.",3);
}
...
void dialog_050(void){
    ...
    d("se ofrecer|a a ir con ella.",3);
}
...
void dialog_053(void){
    h("[ Julia ]");
                d("sus casas est*n vac|as ",1);
    d("y por lo que he o|do, nadie los ha",2);
    d("vuelto a ver.",3);
}
...
void dialog_075(void){
    ...
    d("hay una investigaci$n en marcha. ",2);
    d("No puede entrar.",3);
}
...
void dialog_082(void){
    ...
    d("Tambi&n estoy investigando el caso.",3);
}
...
void dialog_085(void){
    ...
    d("pueda estar detr*s de todo esto?",2);
    d("",3);
}
...
void dialog_089(void){
    h("[ Sabrina ]");
                d(" Siempre parec|a estar ",1);
    d("ocultando algo. Alice dec|a que era ",2);
...
void dialog_093(void){
    ...
    d("cuando la polic|a encontr$ el",2);
...
void dialog_094(void){
    ...
    d("de los dos ten|a coche",3);
}

void dialog_095(void){
    h("[ Sabrina ]");
                d(" Hace poco compraron uno. ",1);
    d("Lo s& porque ese d|a estaba en la",2);
    d("feria de compraventa de coches. ",3);
}

void dialog_096(void){
    h("[ Renne ]");
                d(";D$nde y cu*ndo se",1);
...
void dialog_097(void){
    ...
    d("verde hace unos diez d|as. La feria",2);
...
void dialog_098(void){
    ...
    d("la atenci$n despu&s de investigar ",2);
    d("la oficina?",3);
}

void dialog_099(void){
    h("[ Sabrina ]");
                d(" Mmm... D&jame pensar...",1);
    d("",2);
    d("",3);
}
...
void dialog_102(void){
    ...
    d("relaci$n en ese intervalo de tiempo.",2);
    d("",3);
}
...
void dialog_104(void){
  d_n("Elige tu pr$xima pregunta",1);
...
void dialog_402(void){
    ...
    d("Sol|amos hacer escapadas juntas, ",2);
    d("nos encantaban las cataratas.",3);
}

void dialog_403(void){
    h("[ Renne ]");
                d("Veo que est*bais muy ",1);
...
void dialog_412(void){
    ...
    d("amiga, llevamos muchos a<os ",2);
...
void dialog_414(void){
    ...
    d("salir con nadie m*s de un mes.",3);
}
...
void dialog_417(void){
    ...
    d("dos ya os conoc|ais. Es posible ",3);
}

void dialog_418(void){
    h("[ Sabrina ]");
                d(" que haya ocultado ",1);
    d("informaci$n sobre su salud mental. ",2);
    d("",3);
}
...
void dialog_106(void){
  d_n("Treinta minutos despu&s.",1);
    d(" ",2);
    d(" ",3);
}

void dialog_107(void){
  d_n("Sabrina y tu est*is media hora ",1);
...
void dialog_111(void){
    ...
    d("la raz$n de la desaparci$n no est* ",2);
...
void dialog_117(void){
    ...
    d("Cristiano sol|a frecuentar el bar ",2);
...
void dialog_129(void){
    ...
    d("de desaparici$n en la ciudad.",3);
}
...
void dialog_133(void){
    ...
    d("18 a<os y soy repartidor por la ",2);
    d("ciudad.",3);
}
...
void dialog_137(void){
    ...
    d("cl|nica en la entrada de la ",2);
    d("ciudad.",3);
}
...
void dialog_140(void){
    h("[ Renne ]");
                d("Hay algo m*s que me",1);
    d("gustar|a preguntarte.",2);
    d("",3);
}

void dialog_141(void){
    h("[ Renne ]");
                d("Hace diez d|as tuvo lugar ",1);
...
void dialog_144(void){
    ...
    d("alg#n negocio cerca de esta esquina ",2);
...
void dialog_150(void){
    ...
    d("re<ida, ;c$mo se llamaba el tipo ",2);
    d("que gan$...?",3);
}
...
void dialog_155(void){
    ...
    d("hab|a un chaval con un pa<uelo",2);
    d("acompa<*ndolo.",3);
}

void dialog_156(void){
    h("[ Renne ]");
                d(";No hab|a ninguna mujer ",1);
    d("con &l?",2);
    d("",3);
}
...
void dialog_158(void){
    h("[ Renne ]");
                d(";Sabr|as decirme si ",1);
    d("esos dos ten|an alg#n tipo de ",2);
    d("relaci$n? Hermanos, amigos...",3);
}

void dialog_159(void){
    h("[ Carlos ]");
                d("No creo, la verdad. ",1);
    d("Parec|an distantes. ",2);
    d("",3);
}
...
void dialog_161(void){
    ...
    d("tengo un examen m&dico hoy en el ",2);
    d("club y no me gustar|a perd&rmelo.",3);
}
...
void dialog_165(void){
  d_n("Treinta minutos m*s tarde.",1);
    d(" ",2);
    d(" ",3);
}
...
void dialog_168(void){
    ...
    d("caso de desaparici$n en la ciudad.",3);
}

void dialog_169(void){
    h("[ Renne ]");
                d(";Puedo hacerle unas ",1);
    d("cuantas preguntas? Ser* r*pido, lo ",2);
    d("prometo.",3);
}
...
void dialog_171(void){
    ...
    d("gustar|a saber su nombre, edad y",2);
    d("ocupaci$n.",3);
}
...
void dialog_172(void){
    ...
    d("tengo 18 a<os y soy estudiante.",2);
...
void dialog_181(void){
    ...
    d("abogado m*s famoso de la ciudad.",3);
}
...
void dialog_183(void){
    h("[ Renne ]");
                d("Entiendo. Hace siete d|as",1);
    d("que no se sabe nada de ellos y estoy",2);
    d("llevando el caso de la desaparici$n.",3);
}

void dialog_184(void){
    h("[ Maria ]");
                d(";En serio? Dios m|o... ",1);
    d("No ten|a ni idea... Me gustar|a ",2);
...
void dialog_185(void){
    h("[ Renne ]");
                d("Se lo agradezco.  ",1);
    d("D|game, ;recuerda haber visto a la ",2);
    d("pareja por la ciudad? ",3);
}

void dialog_186(void){
    h("[ Maria ]");
                d("D&jeme pensar... La ",1);
...
void dialog_427(void){
    ...
    d("podido ocultarme informaci$n ",2);
...
void dialog_428(void){
    ...
    d("segura de que no. Se preocupa m*s ",2);
    d("por Alice que por s| misma.",3);
}

void dialog_429(void){
    h("[ Renne ]");
                d(";C$mo puedes estar ",1);
    d("tan segura?",2);
    d("",3);
}
...
void dialog_444(void){
    ...
    d("a ning#n Carlos. Cuando he llegado ",2);
...
void dialog_446(void){
    ...
    d("atenci$n estos #ltimos d|as?",3);
}
...
void dialog_192(void){
    ...
    d("me gustar|a hacerle unas cuantas ",2);
    d("preguntas m*s.",3);
}
...
void dialog_198(void){
    ...
    d("alg#n caso en los #ltimos diez",2);
    d("d|as?",3);
}
...
void dialog_201(void){
    h("[ Renne ]");
                d("Tengo m*s preguntas ",1);
    d("sobre Cristiano pero creo que ya no ",2);
    d("sabe m*s, as| que las omitimremos.",3);
}
...
void dialog_203(void){
    ...
    d("favor, ;podr|a indicarme el camino?",3);
}
...
void dialog_204(void){
    ...
    d("izquierda. No tiene p&rdida.",3);
}
...
void dialog_208(void){
    ...
    d("ten|a nada importante que hacer. ",2);
...
void dialog_222(void){
    ...
    d("desaparici$n de Cristiano Machado ",2);
    d("y Alice Zena.",3);
}
...
void dialog_224(void){
    ...
    d("nombre, edad y situaci$n laboral. ",2);
    d("",3);
}
...
void dialog_225(void){
    ...
    d("tengo 19 a<os y trabajo en el ",2);
    d("hospital de la ciudad.",3);
}

void dialog_226(void){
    h("[ Renne ]");
                d(";D$nde se encontraba ",1);
    d("hace diez d|as? ",2);
    d("",3);
}
...
void dialog_227(void){
    h("[ Lucas ]");
                d("Hace diez d|as... Era ",1);
    d("s*bado, as| que estaba trabajando ",2);
    d("en el hospital.",3);
}
...
void dialog_232(void){
    ...
    d("m*s famoso de la ciudad, todo",2);
...
void dialog_233(void){
    ...
    d("chaval de tu edad con un pa<uelo",2);
...
void dialog_234(void){
    ...
    d("No tengo mucha relaci$n con",2);
    d("Cristiano.",3);
}
...
void dialog_239(void){
    ...
    d(" gente sab|a que Cristiano ten|a",2);
    d("un hermano.",3);
}

void dialog_240(void){
    h("[ Lucas ]");
                d("Pi&nselo. Para un abogado ",1);
    d("de prestigio ser|a muy peligroso",2);
...
void dialog_467(void){
    ...
    d("Te sientes inc$modo hablando de ella ",2);
...
void dialog_470(void){
    ...
    d("tambi&n he cometido errores en mis",2);
    d("relaciones.",3);
}
...
void dialog_472(void){
    h("[ Lucas ]");
                d("Supongo que tienes raz$n. ",1);
    d("Perd$name por lo de antes, ;qu& ",2);
    d("quer|as preguntar sobre Maria?",3);
}
...
void dialog_474(void){
    ...
    d("intenta ayudar a los dem*s, sin ",2);
...
void dialog_484(void){
    ...
    d("horas, pero nunca en p#blico.",3);
}

void dialog_485(void){
    h("[ Renne ]");
                d(";Qu& me puedes decir de  ",1);
    d("su aspecto f|sico? ;Es alto? ;Fuerte?",2);
    d("",3);
}

void dialog_486(void){
    h("[ Lucas ]");
                d("Es un chaval de lo m*s ",1);
    d("normal, como yo m*s menos. Con pelo ",2);
...
void dialog_487(void){
    ...
    d("m*s que quieras contarme sobre &l ",2);
...
void dialog_251(void){
    ...
    d("investigaci$n. Que tengas un muy ",2);
    d("buen d|a Lucas.",3);
}
...
void dialog_261(void){
    h("[ Renne ]");
                d("Aperentemente, ten|an",1);
    d("una buena relaci$n, aunque Sabrina",2);
...
void dialog_264(void){
    ...
    d("de la discusi$n que escuch$ Maria. ",2);
    d("",3);
}
...
void dialog_266(void){
    ...
    d("teor|a de que los dos que estaban en ",2);
...
void dialog_268(void){
    ...
    d("todo pod|a seguir manteniendo el ",2);
...
void dialog_269(void){
    ...
    d("f*cil como trabajar en algo que le ",2);
    d("tuviera movi&ndose por la ciudad.",3);
}

void dialog_270(void){
  d_n("Elige tu deducci$n",1);
...
void dialog_503(void){
    h("[ Renne ]");
                d("Eso explicar|a por qu& ",1);
    d("se<al$ a Lucas como un posible ",2);
...
void dialog_293(void){
    h("[ Carlos ]");
                d("Se supon|a que esto no ",1);
    d("ten|a a acabar as|, Alice no hizo ",2);
    d("nada malo.",3);
}
...
void dialog_297(void){
    ...
    d("pelearon hace diez d|as despu&s",2);
...
void dialog_301(void){
  d_n("Elige qui&n crees que es el culpable",1);
...
void dialog_309(void){
    ...
    d("d|as despu&s, tras una de sus ",2);
...
void dialog_313(void){
    ...
    d("c$mo pero Alice se enter$ de todo.",2);
    d("",3);
}
...
void dialog_314(void){
    ...
    d("y dijo que ir|a a la polic|a.",2);
    d("",3);
}
...
void dialog_322(void){
    ...
    d("estaba equivocado, no se merec|a ",2);
    d("ning#n tipo de ayuda.",3);
}
